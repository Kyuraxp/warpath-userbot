...
def post_to_telegraph(title, html_format_content):
    ...
    auth_name = "Kyura-Userbot"
    auth_url = "https://github.com/Kyuraxp/kyura-userbot"
...
async def ini_wm():
    kyura = str(pybase64.b64decode("QGt5dXJhc3VwcG9ydDI="))[2:13]
    usbot =str(pybase64.b64decode("QGt5dXJhc3VwcG9ydDI="))[2:13]
    try:
        await bot(Get(kyura))
