...
async def redis(pong):
    ...
    await pong.edit(
        f"**{ALIVE_NAME}**        \n"
        f"**➠Kecepatan : ** %sms  \n"
        f"**➠Branch : ** Warpath-Userbot \n" % (duration)
    )


@kyura_cmd(pattern="lping$")
async def redis(pong):
    """For .ping command, ping the userbot from any chat."""
