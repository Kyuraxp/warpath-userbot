...
async def redis(alive):
    ...
    output = (
        f"**[Kyura-Userbot](https://github.com/Kyuraxp/kyura-userbot)**\n\n"
        f"╭✠╼━━━━━━━━━━━━━━━━✠\n"
        ...
        f"╰✠╼━━━━━━━━━━━━━━━━✠"
        f"    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/kyurasupport2)** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/kyuraproject)**"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
CMD_HELP.update(
    {
        "alive": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}alive` or `{cmd}on` or `kyura`"
...
CMD_HELP.update(
    {
        "botversion": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}botver`"
